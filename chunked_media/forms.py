...
from knowledge_hub.chunked_media.models import Media
from knowledge_hub.chunked_media.permissions import permission_policy as media_permission_policy
...
def get_media_base_form():
    base_form_override = getattr(settings, 'CHUNKED_MEDIA_FORM_BASE', '')
...
GroupMediaPermissionFormSet = collection_member_permission_formset_factory(
    ...
    'chunked_media/permissions/includes/media_permissions_formset.html'
)
