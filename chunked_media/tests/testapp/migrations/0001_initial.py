    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='related_media', to='knowledge_hub.chunked_media_tests.EventPage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
