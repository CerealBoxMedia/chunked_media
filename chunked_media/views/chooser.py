...
from knowledge_hub.chunked_media.utils import paginate
...
def get_media_json(media):
    ...
    return {
        'id': media.id,
        'title': media.title,
        'edit_link': reverse('chunked_media:edit', args=(media.id,))
    }
...
def chooser(request):
    ...
    if 'q' in request.GET or 'p' in request.GET or 'collection_id' in request.GET:
        ...
        return render(request, "chunked_media/chooser/results.html", {
    ...
    return render_modal_workflow(request, 'chunked_media/chooser/chooser.html', None, {
        'media_files': media_files,
        'searchform': searchform,
